...
func TestAmf0Number(t *testing.T) {
    Compare(3.14159, 0, "amf0 number float", t)
    Compare(float64(124567890), 0, "amf0 number high", t)
    Compare(-34.2, 0, "amf0 number negative", t)
}
...
func TestAmf3Double(t *testing.T) {
    Compare(3.14159, 3, "amf3 double float", t)
...
func TestAmf3ByteArray(t *testing.T) {
    ...
    _, _ = enc.EncodeAmf3ByteArray(buf, expect, true)
